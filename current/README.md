...
An [Uploader](#uploader) descendant, this class handles [metadata-only](https://developers.google.com/drive/api/guides/create-file#create-metadata-file) uploads. It doesn't have own methods or properties.
...
| <a id="uploader_set_data"></a>`setData(`<br>&nbsp;`  data:`&nbsp;&nbsp;[`Data`](#data)`,`<br>&nbsp;`  mimeType:`&nbsp;&nbsp;[`string`](#mime_type)<br>`)` | Returns `this`                                                                                            | Sets the data and its MIME type.                                                                                                                                                                            |
