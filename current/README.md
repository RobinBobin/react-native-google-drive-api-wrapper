...
2. <a id="c_usage"></a>[Usage](#usage)
   ...
   1. <a id="c_usage_gdrive"></a>[GDrive](#usage_gdrive)
...
## <a id="usage_gdrive"></a>[GDrive](#c_usage_gdrive)
...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <a id="about_get"></a>`get()` | Method, returns `Promise<`[About resource](https://developers.google.com/drive/api/v3/reference/about#resource)`>` | [Gets](https://developers.google.com/drive/api/v3/reference/about/get) information about the user, the user's Drive, and system capabilities.<br><br>Parameters:<br><ul><li>`queryParameters:` [TAboutGetQueryParameters](#t_about_get_query_parameters)</li></ul> |
...
| Name                                                         | Type                                                                                                                          | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `copy()`                                                     | Method, returns `Promise<`[File resource](https://developers.google.com/drive/api/v3/reference/files#resource)`>`             | Creates a [copy](#https://developers.google.com/drive/api/v3/reference/files/copy) of a file.<br><br>Parameters:<br><ul><li>`fileId: string`</li><li>`parameters?:` [IFilesCopyParameters](#ifilescopyparameters)</li></ul>                                                                                                                                                                                                                                                                                                   |
| <a id="files_create_if_not_exists"></a>`createIfNotExists()` | Method, returns `Promise<`[`ICreateIfNotExistsResultType`](#i_create_if_not_exists_result_type)`>`                            | Invokes [`execute()`](#uploader_execute) on the passed in [`uploader`](#uploader), if the file described with `queryParameters` doesn't exist.<br><br>Parameters:<br><ul><li>`queryParameters:` [query parameters](https://developers.google.com/drive/api/reference/rest/v3/files/list#query-parameters)</li><li>`uploader:` an [`Uploader`](#uploader) descendant</li></ul>Throws:<br><ul><li>[`UnexpectedFileCountError`](#unexpected_file_count_error) if there are 2 or more files matching `queryParameters`.</li></ul> |
| `delete()`                                                   | Method, returns `Promise<void>`                                                                                               | [Deletes](https://developers.google.com/drive/api/v3/reference/files/delete) a file.<br><br>Parameters:<br><ul><li>`fileId: string`</li></ul>                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `export()`                                                   | Method, returns `Promise<`[`TBlobToByteArrayResultType`](t_blob_to_byte_array_result_type)`>`                                 | [Exports](https://developers.google.com/drive/api/v3/reference/files/export) a Google Doc to the requested MIME type.<br><br>Parameters:<br><ul><li>`fileId: string`</li><li>`queryParameters:` [query parameters](https://developers.google.com/drive/api/reference/rest/v3/files/export#query-parameters)</li></ul>                                                                                                                                                                                                         |
| `generateIds()`                                              | Method, returns `Promise<`[`object`](https://developers.google.com/drive/api/v3/reference/files/generateIds#response-body)`>` | [Generates](https://developers.google.com/drive/api/v3/reference/files/generateIds) file IDs. [This info](https://developers.google.com/drive/api/guides/manage-uploads#pre-generated) might seem interesting.<br><br>Parameters:<br><ul><li>`queryParameters?:` [query parameters](https://developers.google.com/drive/api/reference/rest/v3/files/generateIds#query-parameters)</li></ul>                                                                                                                                   |
